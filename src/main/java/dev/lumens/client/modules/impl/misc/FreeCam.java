...
import dev.lumens.base.events.impl.player.EventMove;
...
public final class FreeCam extends Module {
   ...
   public void onWorldRender(EventRender3D e) {
      if (this.pos != null) {
         Render3DUtil.drawBox(new Box(this.pos.x - (double)(mc.player.getWidth() / 2.0F), this.pos.y, this.pos.z - (double)(mc.player.getWidth() / 2.0F), this.pos.x + (double)(mc.player.getWidth() / 2.0F), this.pos.y + (double)mc.player.getHeight(), this.pos.z + (double)(mc.player.getWidth() / 2.0F)), LUMENS.getThemeManager().getClientColor(90).getRGB(), 1.0F);
      }
   }
