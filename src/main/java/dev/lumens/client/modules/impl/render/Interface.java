...
import dev.lumens.base.events.impl.input.EventMouse;
import dev.lumens.base.events.impl.input.EventSetScreen;
import dev.lumens.base.events.impl.other.EventWindowResize;
import dev.lumens.base.events.impl.player.EventUpdate;
import dev.lumens.base.events.impl.render.EventHudRender;
import dev.lumens.client.hud.elements.component.InformationComponent;
import dev.lumens.client.hud.elements.component.KeybindsComponent;
import dev.lumens.client.hud.elements.component.NotifyComponent;
import dev.lumens.client.hud.elements.component.PotionsComponent;
import dev.lumens.client.hud.elements.component.StaffComponent;
import dev.lumens.client.hud.elements.component.TargetHudComponent;
import dev.lumens.client.hud.elements.component.WatermarkComponent;
...
import dev.lumens.utility.render.display.base.GuiUtil;
...
public final class Interface extends Module {
   ...
   public final BooleanSetting hudBlur = new BooleanSetting("Blur", "Размытие фона элементов HUD (выкл = +FPS)", true);
   ...
   private Interface() {
      ...
      Lumens.getInstance().getNotifyManager().setNotifyComponent(notifyComponent);
       this.addElement(new InformationComponent("Information", 0.0F, 0.0F, 960.0F, 495.5F, 10.0F, -10.0F, DraggableHudElement.Align.BOTTOM_LEFT));
