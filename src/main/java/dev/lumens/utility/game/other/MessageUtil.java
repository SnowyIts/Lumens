package dev.lumens.utility.game.other;
...
import dev.lumens.utility.render.display.base.color.ColorUtil;
...
public final class MessageUtil implements IMinecraft {
   ...
   public static void displayMessage(MessageUtil.LogLevel level, Object message) {
      Text icon = createGradientText("Javelin", Lumens.getInstance().getThemeManager().getCurrentTheme().getColor(), Lumens.getInstance().getThemeManager().getCurrentTheme().getSecondColor());
